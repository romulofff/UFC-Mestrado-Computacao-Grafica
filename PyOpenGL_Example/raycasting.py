...
class Raycasting:
    def __init__(self,scene, camera, direction, height, width, nlines, ncols) -> None:
        ...
        self.point_init = Point(-width*0.5 + self.width_frame*0.5 , height*0.5 - 0.5*self.height_frame, -direction.matrix)
    ...
    def create_matrix(self):
        ...
        for line in range(0,self.nlines):
            ...
            for col in range(0,self.ncols):
                ...
                self.matrix[line][col] = [uniform(0, 1), uniform(0, 1), uniform(0, 1)]
        return self.matrix